...
export const pricingCardVariants = cva("rounded-lg p-4 py-6 w-full", {
    variants: {
        variant: {
...
export const pricingCardIconVariants = cva("size-5", {
    variants: {
        variant: {
...
export const pricingCardSecondaryTextVariants = cva("text-neutral-700", {
    variants: {
        variant: {
...
export const pricingCardBadgeVariants = cva("text-black text-sm font-normal p-1", {
    variants: {
        variant: {
