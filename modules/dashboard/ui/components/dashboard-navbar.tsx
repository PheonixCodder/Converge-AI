...
export const DashboardNavbar = () => {
  ...
  return (
    <>
      <nav className="flex px-4 gap-x-2 items-center py-3 border-b bg-background rounded-2xl">
        <Button
        ...
        <Button
          ...
          className="h-9 w-60 justify-start font-normal text-muted-foreground hover:text-muted-foreground hover:cursor-pointer"
        >
